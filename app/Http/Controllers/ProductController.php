...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product->is_active= 1;//defult vabe 1 diye active kora hoyeche
        ...
        if($request->hasFile('images'))
        {
            ...
            foreach($files as $file)
            {
                ...
                $imageName= 'product_'. time() . ++$i . '.' . $extension;
                $location='/images/uploads/';
                $file->move(public_path('').$location,$imageName);//forder file path
            ...
            return back()->with('error', 'Product was not Upload!');
